...
return false if check_response('update_log', ['10ダメージを与えました'])
p2game.wait_for_response('update_log')
return false if p2game.check_response('update_log', ['10ダメージを受けました'])
